...
public class HotelManagementSystem extends JFrame {
    ...
    private void updateDetailsFromSelection() {
        ...
        if (selectedRow >= 0) {
            ...
            Object promoCodeObj = model.getValueAt(selectedRow, 9);
            String promoCode = (promoCodeObj != null) ? promoCodeObj.toString() : "";
            detailLabels[8].setText(promoCode);
        }
    }
    ...
    private class AddEditDialog extends JDialog {
        ...
        public AddEditDialog(String title, 
            ...
            if (!adults.isEmpty()) {
                ...
                adultsComboBox.setSelectedIndex(0);
            }
            ...
            if (!children.isEmpty()) {
                ...
                childrenComboBox.setSelectedIndex(0);
            }
        ...
        private class SaveListener implements ActionListener {
            ...
            public void actionPerformed(ActionEvent e) {
                try (Connection conn = getConnection()) {
                    ...
                    if (utilArrival == null || utilDeparture == null) {
                        JOptionPane.showMessageDialog(
                            HotelManagementSystem.this, 
                    ...
                    // Validate promo code if not empty
                    if (!promoCode.isEmpty()) {
                        try (PreparedStatement stmt = conn.prepareStatement(
                            "SELECT discount FROM promo_codes WHERE code = ?"
                        )) {
    ...
    private static class LoginDialog extends JDialog {
        ...
        private static final String USERNAME = HotelManagementSystem.USERNAME;
